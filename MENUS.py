...
class Runtime():
    print('Infinite Menus')

    #this is how you call the module in a real scenario
    create = Menu(menu2, result3) #if you want to fuck around change the menu and result shit here
